...
# IMPORT DATA
#
# depression_new_approach
# }
##IMPORT DATA
Data_Set = "depression_new_approach"
data_set, attribute_information, number_target_classes = Import_INTROMAT_Data.import_data(Data_Set)
...
proportion_of_collaborating_parties = 1  # can be changed to a value<1
num_participating_parties = round(number_of_parties*proportion_of_collaborating_parties)

Secure_Aggregation_SMC = False  # False # True if simulation of SMC part is required
...
for patient_train_index, patient_test_index in kf.split(patients_indices):
    ...
    attributes_range = Import_INTROMAT_Data.find_range_of_data(train_set, attribute_information)
